            ...
            <Card.Body>
              ...
              <Form onSubmit={handleSubmit} noValidate validated={validated}>
                <Form.Group className="mb-3">
                  <Form.Label className='required'>Course Name</Form.Label>
                  <Select
                    required
                    name="courseId"
                    ...
                    onChange={(selectedOption) => handleSelectChange("courseId", selectedOption.courseId)}
                    placeholder="-- Select Course --"
                  />
                  <Form.Control.Feedback type="invalid"> Invalid Course </Form.Control.Feedback>
                </Form.Group>
                <Form.Group className="mb-3">
