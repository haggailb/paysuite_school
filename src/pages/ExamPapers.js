...
const ExamPapers = () => {
  ...
  useEffect(() => {
    setPageTitle('Exam Papers');
    setBackUrl('/exams');
  }, []);


  const handleViewExamPapers = (courseExam) => {
    navigate(`/exams/${courseExam.examCode}/${courseExam.courseCode}/marking`, { state: { courseExam, exam } });
  };
              ...
              <div className="custom-table-wrapper">
                <Table striped bordered hover className="custom-table" >
                  ...
                  <tbody>
                    ...
                    {filteredList.map((courseExam, index) => (
                      <tr key={index}>
                        <td>{courseExam.courseCode}</td>
                        <td>{courseExam.courseName}</td>
                        <td>{courseExam.scheduledDate}</td>
                        <td>{courseExam.startTime} - {courseExam.endTime}</td>
                        <td>
                          <Button className=" btn" onClick={() => handleViewExamPapers(courseExam)}>
                            Update
                          </Button>
                        </td>
                      </tr>
