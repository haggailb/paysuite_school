...
import { samplePrograms, sampleStaffMembers, sampleProgramDirectors} from '../_services/dataServices';
...
const ProgramDirectors = () => {
  ...
  useEffect(() => {
    setPageTitle('Program Directors');
    setBackUrl('/');
  }, []);
  ...
  const filteredList = sampleProgramDirectors.filter(listItem => {
              ...
              <div className="custom-table-wrapper">
                <Table striped bordered hover className="custom-table" >
                  ...
                  <tbody>
                    ...
                    {filteredList.map((director, index) => (
                      <tr key={index}>
                        <td>{director.programCode}</td>
                        <td>{director.programName}</td>
                        <td>{director.staffName}</td>
                        <td>
                          <Dropdown as={ButtonGroup}>
