...
import { getCOA, getBankAccounts, getPaymentMethods, getSuppliers, getDepartments, getDivisions } from "../../_services/dataServices";
  
  const today = <CurleaseDate />;

const NewVoucherBulk = () => {
  ...
  return (
    ...
    <Container className="flex-column justify-content-center align-items-center bg-light">
      <h2 className="page-title text-center mb-4"> Payment Voucher  <br></br>( Bulk )</h2>
                  ...
                  <Col lg={4}>
                    <Form.Group className="mb-2">
                      ...
                      <Select
                        ...
                        onChange={(selectedOption) => handleSelectChange("divId", selectedOption)}
