...
import { getCOA, getBankAccounts, getPaymentMethods, getSuppliers, getDepartments, getEmployees } from "../../_services/dataServices";
  
  const today = <CurleaseDate />;

const NewVoucherEmployee = () => {
  ...
  return (
    ...
    <Container className="flex-column justify-content-center align-items-center bg-light">
      <h2 className="page-title text-center mb-4"> Payment Voucher  <br></br>( Employees )</h2>
                  ...
                  <Col md={6}>
                    <Form.Group className="mb-2">
                      ...
                      <Select
                        ...
                        onChange={(selectedOption) => handleSelectChange("empId", selectedOption)}
...
export default NewVoucherEmployee;
