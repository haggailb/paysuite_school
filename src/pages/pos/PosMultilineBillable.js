...
import { getAllProperties, getBankAccounts, getPaymentMethods } from "../../_services/dataServices";
  
  const today = <CurleaseDate />;

const PosMultilineBillable = () => {
  ...
  return (
    ...
    <Container className="flex-column justify-content-center align-items-center bg-light">
      <h2 className="page-title text-center mb-4"> Multiline Receipt <br></br>(Billable)</h2>
...
export default PosMultilineBillable;
