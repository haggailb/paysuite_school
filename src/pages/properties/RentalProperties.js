...
import NewRentalProperty from "../../components/new_components/NewRentalProperty";
...
const loadClientOptions = (inputText, callback) => {
  ...
  return (
    <div className="form-container mb-5">
      <h2 className="page-title text-center mb-4">Rental Properties</h2>
      <Row className="">
        ...
        <tbody>
          ...
          {paginatedProperties.map((property, index) => (
            <tr key={index}>
              ...
              <td>{property.zoneName}</td>
              <td className="bg-success text-white text-center"> Vacant</td>
              <td>
                <Dropdown as={ButtonGroup} className="text-white">
                  ...
                  <Dropdown.Menu>
                    <h6 className="text-white mb-0 text-center">{property.propertyNo}</h6>
